...
/* This function computes the Greatest Common Divisor (massimo comun divisore) between two numbers.
...
public:
     ...
     */
    explicit rational(I n) : m_num(n), m_den(1)
    {
 ...
 * right. */
template<typename I> rational<I>
...
{
    if (r < rational<I>(0))
        return -r; //qui uso il UNARY minus definito sopra

    return r;
}

/* Free function to compute the inverse of a rational */
template<typename I> rational<I> inv(const rational<I>& r) 
{
